module.exports = {
  ...
  User: {
    ...
    student_name: { type: "number", description: "角色" },
  },
  Auth: {
    account: { type: "string", description: "用户账号" },
    password: { type: "string", description: "用户密码" },
  ...
  schoolNews: {
    ...
    type: {
      type: "number",
      description: "新闻类型(0-学校新闻/1-校内公告/2-校友动态)",
    },
  ...
  intention: {
    ...
    academy: { type: "string", description: "学院" },
    ...
    intentionalityJob1: { type: "string", description: "意向职位1" },
    intentionalityJob2: { type: "string", description: "意向职位2" },
    intentionalityJob3: { type: "string", description: "意向职位3" },
  ...
  queryForm: {
    ...
    educationBackground: { type: "number", description: "学历" },
    major: { type: "string", description: "专业" },
    employmentOrientation: { type: "string", descirption: "意向" },
    intentionalityCity1: { type: "string", description: "意向城市1" },
    intentionalityCity2: { type: "string", description: "意向城市2" },
    intentionalityCity3: { type: "string", description: "意向城市3" },
    intentionalityJob1: { type: "string", description: "意向职位1" },
